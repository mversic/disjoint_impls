...
### Added
- rename helper trait items to disambiguate from original trait

### Fixed
- don't overwrite trait args in nested subgroups
- disallow cfg attributes on params with bounds with assoc bindings

## [1.3.6] - 2026-01-22
### Fixed
- replace bindings containing unknown params with fully qualified assoc bindings
- support duplicate type params activated by different attributes

## [1.3.5] - 2026-01-21
### Added
- support attributes on type params

## [1.3.4] - 2025-12-04
### Fixed
- derivative generic types are not fundamental

## [1.3.3] - 2025-11-27
### Fixed
- consider fully qualified generic params as generic params

## [1.3.2] - 2025-11-26
### Fixed
- separate disjoint subgroups eagerly
