...
//    }
//
//    impl<T0: Dispatch1 + Dispatch2> Kita for T0 where Self: _Kita<<T0 as Dispatch1>::Group, <T0 as Dispatch2>::Group> {
//        const NAME: &'static str = <Self as _Kita<<T0 as Dispatch1>::Group, <T0 as Dispatch2>::Group>>::_NAME;
//    }
//};
//
//
