...
fn main() {
    assert_eq!("Blanket A", <Option<String> as Kita>::NAME);
    assert_eq!("Blanket A", <Option<Vec::<u32>> as Kita>::NAME);
    assert_eq!("Blanket B", <Option<u32> as Kita>::NAME);
    assert_eq!("Blanket B", <Option<i32> as Kita>::NAME);
}
