...
const _: () = {
    ...
    impl<_0, _1> _Kita1<GroupA, GroupB> for (_0, _1) where _0: Dispatch<Group = GroupA>, _1: Dispatch<Group = GroupB> {
        const NAME: &'static str = "Blanket AB";
    }
    impl<_0: Dispatch<Group = GroupB>, _1: Dispatch> _Kita1<GroupB, <_1 as Dispatch>::Group> for (_0, _1) {
        const NAME: &'static str = "Blanket B*";
    }
    ...
    impl<_0, _1> Kita for (_0, _1) where _0: Dispatch, _1: Dispatch, Self: _Kita1<<_0 as Dispatch>::Group, <_1 as Dispatch>::Group> {
        const NAME: &'static str = <Self as _Kita1<<_0 as Dispatch>::Group, <_1 as Dispatch>::Group>>::NAME;
    }
};
*/
