...
const _: () = {
    ...
    impl<T, _TŠČ1> Kita<T> for dyn Kara + Sync
    where
        Self: Kita0<_TŠČ1, T>,
        T: Dispatch<Group = _TŠČ1>,
    {
        const NAME: &'static str = <Self as Kita0<_TŠČ1, T>>::NAME;
    }
    impl<T, _TŠČ1> Kita<T> for dyn Kara
    where
        Self: Kita1<_TŠČ1, T>,
        T: Dispatch<Group = _TŠČ1>,
    {
        const NAME: &'static str = <Self as Kita1<_TŠČ1, T>>::NAME;
    }
};
*/
